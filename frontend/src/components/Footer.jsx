        ...
        <footer className="bg-gray-900 text-white relative overflow-hidden">
            ...
            <div className="bg-orange-500 py-3 text-center">
                <p className="text-white font-medium px-4">
                    24/7 Emergency: <a href="tel:+911234567890" className="underline font-bold hover:text-gray-100">1234-567-890</a>
                </p>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-2">
                        ...
                        <ul className="space-y-3 text-gray-400">
                            <li className="flex items-center gap-2">
                                ...
                                <a href="mailto:help@hopesalive.com" className="hover:text-orange-500 transition-colors">
                                    help@hopesalive.com
                                </a>
                            </li>
                            <li className="flex items-center gap-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-400 mb-4">Subscribe to our newsletter for updates and success stories.</p>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
                    <p className="flex items-center justify-center gap-1 flex-wrap px-4">
                        © 2024 HopesAlive. Built with <BiSolidHeart className="text-orange-500" /> for animals
                    </p>
                </div>
            </div>
        </footer>
